...
# --- Tools (Langchanin @tool decorator) ---
...
def apply_discount(price:float, discount_tier:str) -> float:
    ...
    discounts_percentages = {"gold":23, "silver": 12, "bronze": 5}
    discount = discounts_percentages.get(discount_tier.lower(), 0)
    return round(price * (1 - discount)/100, 2)

# ---- Agent Loop ----

@traceable(name="Langchanin Agent Loop")
def run_agent(question: str):
    ...
    for iteration in range(MAX_ITERATIONS+1):
        ...
        #process only the first tool call in this example
