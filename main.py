...
# Text input to summarize using the language model
information = """
...
# Prompt template used to generate the summary and facts
summary_template ="""
...
# Configure the language model. Temperature 0 means deterministic output.
llm = ChatOpenAI(temperature=0, model_name="gpt-5")

#Using the ollama to use the local model instead of OpenAI API
#llm= ChatOllama(model="gemma3:270m", temperature=0)

chain = summary_prompt_template | llm

# Run the prompt chain and print the model response
